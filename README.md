...
Phase 3 (naturalistic perturbation suite) is merged in: see
[`docs/PERTURBATIONS.md`](docs/PERTURBATIONS.md) and the
`robust_meme_hate_detection.perturbations` module. Next: wire perturbations
into the eval harness and run Phase 5 (Stage-3 robust training).
...
src/robust_meme_hate_detection/
  ...
  perturbations/               Naturalistic text + image perturbations (TextPerturbation, ImagePerturbation, ComposePerturbation)
...
scripts/
  ...
  example_perturbations.py     Materialise a perturbed copy of the dataset on cluster scratch
